...
from tensorflow.keras.layers import (Embedding, Bidirectional, GRU,
...
with open("results.txt", "w") as f:
    f.write("MODEL 3: BIDIRECTIONAL GRU RESULTS\n")
    f.write("="*50 + "\n\n")
...
print("\nSaved: model3_gru.keras, results.txt, results.json")
